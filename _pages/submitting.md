...
To create a blog post in Markdown format, you can modify the [example]({% post_url 2025-04-28-head-pissa %}) Markdown post `_posts/2025-04-28-head-pissa.md` and rename it to `_posts/2025-04-28-[SUBMISSION NAME].md`, where `[SUBMISSION NAME]` is the name of your submission. You can see the result of the sample post .

While most users will want to create a post in the Markdown format, it is also possible to create a post in HTML format. For this, modify instead the example  `_posts/2025-04-28-head-pissa2.html` and rename it to `_posts/2025-04-28-[SUBMISSION NAME].html`. (NOTE: HTML is not officially supported, use at your own risk).
...
Read our [sample blog post]({% post_url 2025-04-28-head-pissa %}) carefully to see how you can add image assets, and how to write using $$\LaTeX$$!
...
2. Double check that your post matches the formatting requirements, including (but not limited to):
    ...
    - Have a short 2-3 sentence abstract in the `description` field of your front-matter ([example](https://github.com/iclr-blogposts/2025/blob/295ab5b4c31f2c7d421a4caf41e5481cbb4ad42c/_posts/2025-04-28-head-pissa.md?plain=1#L4-L6))
    - Have a table of contents, formatted using the `toc` field of your front-matter ([example](https://github.com/iclr-blogposts/2025/blob/295ab5b4c31f2c7d421a4caf41e5481cbb4ad42c/_posts/2025-04-28-head-pissa.md?plain=1#L36-L47))
